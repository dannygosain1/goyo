...
//
  ...
  MPU6050 ACC;
  #define ACC_X_ACC_OFFSET -4809
  #define ACC_Y_ACC_OFFSET 1478
  #define ACC_Z_ACC_OFFSET 2096
  #define ACC_X_GYRO_OFFSET -37
  #define ACC_Y_GYRO_OFFSET -32
  #define ACC_Z_GYRO_OFFSET 35
